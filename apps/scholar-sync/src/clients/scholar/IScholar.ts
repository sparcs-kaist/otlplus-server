...
export namespace IScholar {
  ...
  export class ExamtimeBody {
    ...
    semester!: number;
    /** 동기화 대상 시험시간 정보 */
    @Type(() => ScholarExamtimeType)
    @ValidateNested({ each: true })
    examtimes!: ScholarExamtimeType[];
  }
   ...
   */
  export class ScholarExamtimeType {
    /** 개설 연도 */
    @Transform(({ value }) => parseInt(value))
    @IsInt()
    LECTURE_YEAR!: number;
  ...
  export class ClasstimeBody {
    ...
    semester!: number;
    /** 동기화 대상 수업시간 정보 */
    @Type(() => ScholarClasstimeType)
    @ValidateNested({ each: true })
    classtimes!: ScholarClasstimeType[];
  }
  ...
  export class ScholarClasstimeType {
    /** 개설 연도 */
    @Transform(({ value }) => parseInt(value))
    @IsInt()
    LECTURE_YEAR!: number;
  ...
  export class TakenLectureBody {
    ...
    semester!: number;
    /** 동기화 대상 수강 강의 정보 */
    @Type(() => ScholarAttendType)
    @ValidateNested({ each: true })
    attend!: ScholarAttendType[];
  }
   ...
   */
  export class ScholarAttendType {
    /** 개설 연도 */
    @IsInt()
    @Transform(({ value }) => parseInt(value))
    LECTURE_YEAR!: number;
  ...
  export class ScholarDegreeType {
    /** 학번 */
    @Transform(({ value }) => parseInt(value))
    @IsInt()
    STUDENT_NO!: number;
