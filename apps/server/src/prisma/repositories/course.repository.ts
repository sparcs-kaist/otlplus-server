...
import { applyOffset, applyOrder, formatNewLectureCodeWithDot, orderFilter } from '@src/common/utils/search.utils';
...
export class CourseRepository {
  ...
  public async getLecturesByCourseId(query: LectureQueryDto, id: number): Promise<ELecture.Details[]> {
  ...
  public async getReviewsByCourseId(query: ICourse.ReviewQueryDto, id: number): Promise<EReview.Details[]> {
  ...
  async getCourseAutocomplete({ keyword }: ICourse.AutocompleteQueryDto): Promise<ECourse.Extended | null> {
