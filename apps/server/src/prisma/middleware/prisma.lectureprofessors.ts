...
export class LectureProfessorsMiddleware implements IPrismaMiddleware.IPrismaMiddleware {
  ...
  private async lectureCalcAverage(reviews: review_review[]): Promise<IReview.reCalcScoreReturn> {
