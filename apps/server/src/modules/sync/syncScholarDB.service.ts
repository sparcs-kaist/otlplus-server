...
export class SyncScholarDBService {
  ...
  deriveDepartmentInfo(lecture: ISync.ScholarLectureType): LectureDerivedDepartmentInfo {
    return {
      id: lecture.DEPT_ID,
  ...
  deriveCourseInfo(lecture: ISync.ScholarLectureType): LectureDerivedCourseInfo {
    return {
  ...
  deriveProfessorInfo(charge: ISync.ScholarChargeType): ChargeDerivedProfessorInfo {
    return {
  ...
  deriveLectureInfo(lecture: ISync.ScholarLectureType, course_id: number): DerivedLectureInfo {
    return {
      code: lecture.SUBJECT_NO,
      new_code: lecture.SUBJECT_NO,
