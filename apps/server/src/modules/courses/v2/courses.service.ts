  ...
  public async getCourses(
    ...
    if (keyword) {
      try {
        ...
        queryResult = await this.courseRepository.getCourses(
          department,
          type,
          level,
          keyword,
      ...
      queryResult = await this.courseRepository.getCourses(department, type, level, keyword, term, order, offset, limit)
    }
