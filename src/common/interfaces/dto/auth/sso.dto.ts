export class SSOUser {
  ...
  sid!: string; // RP에서 사용자를 식별할 수 있는 고유한 값입니다.
  ...
  birthday?: Date; // 사용자의 생일입니다. YYYY-MM-DD 형식의 날짜 또는 빈 문자열 값입니다.
  ...
  kaist_info!: KaistInfo; // 사용자의 KAIST Portal 데이터입니다. ku_std_no, kaist_uid, ku_psft_user_status_kor, employeeType, ku_person_type, ku_kaist_org_id, ku_psft_user_status, ku_acad_prog_code, ku_born_date, ku_person_type_kor, sn, mail, displayname, givenname, ku_sex, ku_kname의 데이터가 포함되어 있습니다.
  kaist_info_time?: Date; // kaist_info를 업데이트한 날짜입니다. YYYY-MM-DD 형식의 날짜 또는 빈 문자열 값입니다.
