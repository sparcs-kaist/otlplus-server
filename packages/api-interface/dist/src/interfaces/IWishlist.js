...
(function (IWishlist) {
  ...
  IWishlist.AddLectureDto = AddLectureDto;
  class RemoveLectureDto {}
  __decorate(
    [(0, class_validator_1.IsNumber)(), (0, class_transformer_1.Type)(() => Number), __metadata('design:type', Number)],
    RemoveLectureDto.prototype,
    'lecture',
    void 0,
  );
  IWishlist.RemoveLectureDto = RemoveLectureDto;
})(IWishlist || (exports.IWishlist = IWishlist = {}));
