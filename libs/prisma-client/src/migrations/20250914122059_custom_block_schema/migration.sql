...
-- AddForeignKey
ALTER TABLE `timetable_timetable_customblocks` ADD CONSTRAINT `fk_timetable_timetable_custom__timetable_timetalble` FOREIGN KEY (`timetable_id`) REFERENCES `timetable_timetable`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
