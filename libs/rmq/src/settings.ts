...
export const QueueNames = {
  ...
  NOTI_BATCH_URGENT: 'notifications.batch.urgent.queue',
  NOTI_BATCH_NORMAL: 'notifications.batch.normal.queue',
  NOTI_BATCH_BULK: 'notifications.batch.bulk.queue',
  NOTI_BATCH_URGENT_DLQ: 'notifications.batch.urgent.dlq',
  NOTI_BATCH_NORMAL_DLQ: 'notifications.batch.normal.dlq',
  NOTI_BATCH_BULK_DLQ: 'notifications.batch.bulk.dlq',
...
export const QueueSymbols = {
  ...
  NOTI_BATCH_URGENT: 'NOTI_BATCH_URGENT',
  NOTI_BATCH_NORMAL: 'NOTI_BATCH_NORMAL',
  NOTI_BATCH_BULK: 'NOTI_BATCH_BULK',
  NOTI_BATCH_URGENT_DLQ: 'NOTI_BATCH_URGENT_DLQ',
  NOTI_BATCH_NORMAL_DLQ: 'NOTI_BATCH_NORMAL_DLQ',
  NOTI_BATCH_BULK_DLQ: 'NOTI_BATCH_BULK_DLQ',
...
const getRabbitMQConfig = (): {
  ...
  return {
    ...
    queueConfig: {
      ...
      NOTI_BATCH_URGENT: {
        exchange: ExchangeNames.NOTIFICATIONS,
        routingKey: 'notifications.batch.urgent',
        queue: QueueNames.NOTI_BATCH_URGENT,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
          deadLetterExchange: ExchangeNames.NOTIFICATIONS_DLX,
      ...
      NOTI_BATCH_NORMAL: {
        exchange: ExchangeNames.NOTIFICATIONS,
        routingKey: 'notifications.batch.normal',
        queue: QueueNames.NOTI_BATCH_NORMAL,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
          deadLetterExchange: ExchangeNames.NOTIFICATIONS_DLX,
      ...
      NOTI_BATCH_BULK: {
        exchange: ExchangeNames.NOTIFICATIONS,
        routingKey: 'notifications.batch.bulk',
        queue: QueueNames.NOTI_BATCH_BULK,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
          deadLetterExchange: ExchangeNames.NOTIFICATIONS_DLX,
      ...
      NOTI_BATCH_URGENT_DLQ: {
        exchange: ExchangeNames.NOTIFICATIONS_DLX,
        routingKey: 'notifications.batch.urgent',
        queue: QueueNames.NOTI_BATCH_URGENT_DLQ,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
        },
      },
      NOTI_BATCH_NORMAL_DLQ: {
        exchange: ExchangeNames.NOTIFICATIONS_DLX,
        routingKey: 'notifications.batch.normal',
        queue: QueueNames.NOTI_BATCH_NORMAL_DLQ,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
        },
      ...
      NOTI_BATCH_BULK_DLQ: {
        exchange: ExchangeNames.NOTIFICATIONS_DLX,
        routingKey: 'notifications.batch.bulk',
        queue: QueueNames.NOTI_BATCH_BULK_DLQ,
        createQueueIfNotExists: true,
        queueOptions: {
          durable: true,
        },
